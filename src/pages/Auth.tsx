      ...
      <div className="container flex items-center justify-center py-20">
        <div className="w-full max-w-md glass-card p-8">
          <div className="text-center mb-6">
            <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-primary shadow-[0_0_20px_hsl(var(--primary)/0.4)]">
              <span className="text-lg font-bold text-primary-foreground">EC</span>
            </div>
            <h1 className="font-serif text-2xl font-bold text-foreground">
              {isLogin ? t('auth.login') : t('auth.signup')}
            </h1>
            <p className="text-sm text-muted-foreground mt-1">Examen Civique 2026</p>
          </div>
